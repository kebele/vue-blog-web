    ...
    <div class="posts-container">
      <div class="post">
        ...
        <p class="text">
          ...
          Dolor laboriosam voluptatem ex praesentium magni error debitis maxime
          alias autem distinctio. Fuga, esse velit!
        </p>
        <p class="text">
      ...
      <div class="post">
        <img src="../assets/images/blog-2.jpg" alt="" class="image" />
        <div class="date">
          <i class="far fa-clock"></i>
          <span>1st may, 2021</span>
        </div>
      ...
      <div class="post">
        <img src="../assets/images/blog-3.jpg" alt="" class="image" />
        <div class="date">
          <i class="far fa-clock"></i>
          <span>1st may, 2021</span>
        </div>
